 ...
 */
package io.github.rosemoe.editor.core.extension.extensions.widgets.layout.model;
...
public class WordwrapModel {
    ...
    public void breakLines(int startLine, int endLine, CodeAnalyzerResultContent text) {
